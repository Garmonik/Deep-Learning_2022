# -*- coding: utf-8 -*-
"""[homework]pandas.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1b0dm-IlKyQMErF11aXt6ChHx5zh25Yud
...
data.groupby(['Gender', 'City_Category'])['Gender'].value_counts()
...
data[(data['Gender'] == 'F') & (data['Age'] > '46') & (data['Age'] < '50') & (data['Purchase'] > 20000)]
...
data[((data['Gender'] == 'M') & (data['Age'] > '26') & (data['Age'] < '35')) | ((data['Gender'] == 'F') & (data['Age'] > '36'))]
